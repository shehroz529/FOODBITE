package com.example.foodbite.ui
...
import com.example.foodbite.adapters.FavoriteMealsRecyclerAdapter
import com.example.foodbite.data.pojo.MealDB
import com.example.foodbite.data.pojo.MealDetail
import com.example.foodbite.databinding.FragmentFavoriteMealsBinding
...
import com.example.foodbite.ui.fragments.HomeFragment.Companion.MEAL_AREA
import com.example.foodbite.ui.fragments.HomeFragment.Companion.MEAL_ID
import com.example.foodbite.ui.fragments.HomeFragment.Companion.MEAL_NAME
...
class FavoriteMeals : Fragment() {
    ...
    private fun observeBottomDialog() {
        detailsMVVM.observeMealBottomSheet().observe(viewLifecycleOwner)
        { t->
