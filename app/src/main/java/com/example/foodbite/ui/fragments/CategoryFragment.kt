...
import com.example.foodbite.data.pojo.Category
import com.example.foodbite.databinding.FragmentCategoryBinding
import com.example.foodbite.mvvm.CategoryMVVM
...
class CategoryFragment : Fragment(R.layout.fragment_category) {
    ...
    private fun observeCategories() {
        categoryMvvm.observeCategories().observe(viewLifecycleOwner) { t ->
